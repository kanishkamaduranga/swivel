...
- GET Main Types 
<pre>
 REQUEST :    curl --location --request GET 'http://127.0.0.1:8000/api/v1/main_types'
</pre>
<pre>
 RESPONSE :-   {
                   "status": 200,
...
- GET Fields 
<pre>
 REQUEST :   curl --location --request GET 'http://127.0.0.1:8000/api/v1/fields/{main_types}'
</pre>
...
<pre>
 REQUEST :- curl --location --request POST 'http://127.0.0.1:8001/api/v1/search?main_types=ticket&field=tags&keyword=Nevada' 
</pre>
